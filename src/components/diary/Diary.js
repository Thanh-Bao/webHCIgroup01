        ...
        <div id="align-top">
          ...
          <div className="container">
            ...
            <ul className="nav  nav-pills space-tab center-tabs" role="tablist">
              ...
              <li className="nav-item size-tab">
                <a className="nav-link" data-toggle="tab" href="#week56">Week 5,6</a>
              </li>
              <li className="nav-item size-tab">
                <a className="nav-link" data-toggle="tab" href="#week78">Week 7,8</a>
              </li>
...
<Image hinhanh="Hình Ảnh Tuần 4" image="image/week4.jpg" ></Image>
              ...
              <div id="week56" className="container tab-pane fade"><br />
                ...
                <Table tienDo="Hoàn Thành" image="" congviecBao="Thiết kế Trang Home Project và Đổi ngôn ngữ" congviecCuong="Thiết kế Phần Login và Breadcrumb"
                  ...
                  <Image hinhanh="Hình Ảnh Tuần 5&6: Phân Công Về Nhà" image="image/week56.png" ></Image>
              </div>
